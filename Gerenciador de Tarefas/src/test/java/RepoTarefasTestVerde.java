...
class RepoTarefasTestVerde {
    ...
    void removeTarefa() {
        ...
        assertEquals("Tarefa excluída!", retorno);
    }

    @Test
    void getTarefa() {
        RepoTarefas repoTarefas = new RepoTarefas();
        repoTarefas.addTarefa("Tarefa 1");
        repoTarefas.addTarefa("Tarefa 2");
    ...
    void editTitulo() {
        ...
        repoTarefas.editTitulo(1, "Tarefa 2");
        Tarefa tarefa = repoTarefas.getTarefa(1);

        assertNotNull(tarefa);
        assertEquals("Tarefa 2", tarefa.getTitulo());
    ...
    void editDescricao() {
        ...
        Tarefa tarefa = repoTarefas.getTarefa(1);
        repoTarefas.editDescricao(1, "Tarefa de Código");

        assertNotNull(tarefa);
        assertEquals("Tarefa de Código", tarefa.getDescricao());
    }
